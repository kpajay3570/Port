<div align="center">
  ...
  ![GitHub repo size](https://img.shields.io/github/repo-size/kpajay3570/portfolio-website)
  ![GitHub stars](https://img.shields.io/github/stars/kpajay3570/portfolio-website?style=social)
  ![GitHub forks](https://img.shields.io/github/forks/kpajay3570/portfolio-website?style=social)
...
```bash
sudo git clone https://github.com/kpajay3570/portfolio-website.git
```

Windows:

```bash
git clone https://github.com/kpajay3570/portfolio-website.git
```
